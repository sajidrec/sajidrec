...
<table>
<tr>
<td width="33%" align="center"><h3>03</h3><sub>MOBILE STACKS</sub><p>Flutter · React Native · Android</p></td>
<td width="33%" align="center"><h3>1,500+</h3><sub>PROBLEMS SOLVED</sub><p>Algorithms · Data structures</p></td>
<td width="33%" align="center"><h3>Production</h3><sub>PRODUCT EXPERIENCE</sub><p>Restaurants · Courier · Sorting</p></td>
</tr>
</table>
...
`Kotlin` `XML` `MVVM` `LiveData` `Coroutines` `RecyclerView`
...
From algorithmic challenges to production code, problem solving is at the heart of how I work. Explore my contest history and practice profiles below.
...
- **Problem solving:** Competitive programming taught me to reason about edge cases, complexity, and correctness.
- **Production engineering:** I care about what happens when connectivity drops, an app resumes, or a token expires.
- **Continuous learning:** I'm deepening my knowledge of Android internals, background execution, and app reliability.

<details>
<summary><b>A little more about my journey</b></summary>
...
### Have a mobile app challenge in mind?
